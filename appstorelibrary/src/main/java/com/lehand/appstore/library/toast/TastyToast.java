package com.lehand.appstore.library.toast;
...
import com.lehand.appstore.library.R;
...
public class TastyToast {
    ...
    public static Toast makeText(Context context, String msg, int length, int type) {
        ...
        switch (type) {
            case 1: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_success_layout, null, false);
            ...
            case 2: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_warning_layout, null, false);
                TextView text = (TextView) layout.findViewById(R.id.toastMessage);
                text.setText(msg);
            ...
            case 3: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_error_layout, null, false);
                TextView text = (TextView) layout.findViewById(R.id.toastMessage);
                text.setText(msg);
            ...
            case 4: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_info_layout, null, false);
                TextView text = (TextView) layout.findViewById(R.id.toastMessage);
                text.setText(msg);
            ...
            case 5: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_default_layout, null, false);
                TextView text = (TextView) layout.findViewById(R.id.toastMessage);
                text.setText(msg);
            ...
            case 6: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_confusing_layout, null, false);
                TextView text = (TextView) layout.findViewById(R.id.toastMessage);
                text.setText(msg);
