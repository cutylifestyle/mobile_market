package com.sixin.police.market.widget.submitbutton;
...
public class SubmitButton extends View {
    ...
    public SubmitButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        buttonTextColor = typedArray.getColor(R.styleable.SubmitButton_buttonTextColor,Color.parseColor("#ffffff"));
