...
public class RatingBar extends View {
  ...
  private void parseAttrs(AttributeSet attrs) {
    ...
    borderColor = arr.getColor(R.styleable.RatingBar_srb_borderColor, getResources().getColor(R.color.srb_golden_stars));
  ...
  public interface OnRatingBarChangeListener {
     ...
     */
    void onRatingChanged(RatingBar simpleRatingBar, float rating, boolean fromUser);
