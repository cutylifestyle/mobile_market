...
/**
 * Created by malia on 2017/7/20 18:02.
...
public abstract class JsonCallback<T> extends AbsCallback<T> {
    ...
    public void onStart(Request<T, ? extends Request> request) {
        ...
        LogUtils.e(" onStart ");
        if (!Analyzing.isEmpty(((AppStore)AppUtils.getContext()).getUserInfo())) {
    ...
    public T convertResponse(Response response) throws Throwable {
        ...
        LogUtils.e("主要作用是解析网络返回的 response 对象,生产onSuccess回调中需要的数据对象");
        if (type == null) {
            if (clazz == null) {
