...
public class ApkUtils {
    ...
    public static void install(Context context, File uriFile) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri apkUri = FileProvider.getUriForFile(context, "com.sixinfor.im.provider", uriFile);
            //临时授权该 Uri 所代表的文件
    ...
    public static void openFile(File var0, Context var1) {
        ...
        try {
            ...
            AToast.show("没有找到打开此类文件的程序");
        }
    }
    /**
     *7.0 文件打开方式 获取打开文件的intent
     */
    public static Intent getOpenFileIntent(File var0, Context var1) {
        Intent var2 = new Intent();
        var2.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        var2.setAction(Intent.ACTION_VIEW);
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.N){
