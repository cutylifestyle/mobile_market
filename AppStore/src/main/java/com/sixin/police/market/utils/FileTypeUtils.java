...
public class FileTypeUtils {
    ...
    public final static String FILE_TYPE_HTML = "html";
    public final static String FILE_TYPE_DOC = "doc";
    public final static String FILE_TYPE_HTM = "htm";
    public final static String FILE_TYPE_PDF = "pdf";
    public final static String FILE_TYPE_RMVB = "rmvb";
    ...
    public final static String FILE_TYPE_JAR = "jar";
